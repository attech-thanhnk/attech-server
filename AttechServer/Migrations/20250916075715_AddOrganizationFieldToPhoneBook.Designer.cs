...
namespace AttechServer.Migrations
{
    ...
    [Migration("20250916075715_AddOrganizationFieldToPhoneBook")]
    partial class AddOrganizationFieldToPhoneBook
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.Main.InternalDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id", "Deleted")
                        .HasDatabaseName("IX_InternalDocument");

                    b.HasIndex(new[] { "Id", "Deleted" }, "IX_InternalDocument");

                    b.ToTable("InternalDocuments", (string)null);
                });

            modelBuilder.Entity("AttechServer.Domains.Entities.Main.LanguageContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id", "Deleted")
                        .HasDatabaseName("IX_LanguageContent");

                    b.HasIndex(new[] { "Id", "Deleted" }, "IX_LanguageContent");

                    b.ToTable("LanguageContents", (string)null);
                });

            modelBuilder.Entity("AttechServer.Domains.Entities.Main.LanguageContentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_LanguageContentCategory");
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.Main.PhoneBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id", "Deleted")
                        .HasDatabaseName("IX_PhoneBook");

                    b.HasIndex(new[] { "Id", "Deleted" }, "IX_PhoneBook");
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.Main.InternalDocument", b =>
                {
                    b.HasOne("AttechServer.Domains.Entities.Main.Attachment", "Attachment")
                        .WithMany()
